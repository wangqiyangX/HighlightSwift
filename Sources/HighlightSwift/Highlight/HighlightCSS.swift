struct HighlightCSS {
    static func light(_ theme: HighlightTheme) -> String {
        ...
        case .rosePine:
            return "pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs{color:#575279}.hljs-comment,.hljs-meta{color:#9893a5}.hljs-deletion,.hljs-doctag,.hljs-regexp,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id,.hljs-selector-pseudo,.hljs-tag,.hljs-template-tag,.hljs-variable.language_{color:#b4637a}.hljs-link,.hljs-literal,.hljs-number,.hljs-params,.hljs-template-variable,.hljs-type,.hljs-variable{color:#d7827e}.hljs-attribute,.hljs-built_in{color:#ea9d34}.hljs-selector-tag{color:#286983}.hljs-keyword,.hljs-property,.hljs-selector-tag,.hljs-subst,.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#56949f}.hljs-addition,.hljs-bullet,.hljs-quote,.hljs-string,.hljs-symbol{color:#286983}.hljs-code,.hljs-formula,.hljs-section{color:#d7827e}.hljs-attr,.hljs-char.escape_,.hljs-keyword,.hljs-name,.hljs-operator{color:#907aa9}.hljs,.hljs-punctuation{color:#575279」.hljs-emphasis{font-style:italic}.hljs-strong{font-weight:700}"
        case .silk:
            /*
             Theme: Silk Light
    ...
    static func dark(_ theme: HighlightTheme) -> String {
        ...
        case .rosePine:
             ...
             */
            return "pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs-comment,.hljs-meta{color:#6e6a86}.hljs-deletion,.hljs-doctag,.hljs-regexp,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id,.hljs-selector-pseudo,.hljs-tag,.hljs-template-tag,.hljs-variable.language_{color:#eb6f92}.hljs-link,.hljs-literal,.hljs-number,.hljs-params,.hljs-template-variable,.hljs-type,.hljs-variable{color:#ea9a97}.hljs-attribute,.hljs-built_in{color:#f6c177}.hljs-selector-tag{color:#3e8fb0}.hljs-keyword,.hljs-property,.hljs-selector-tag,.hljs-subst,.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function_{color:#9ccfd8}.hljs-addition,.hljs-bullet,.hljs-quote,.hljs-string,.hljs-symbol{color:#3e8fb0}.hljs-code,.hljs-formula,.hljs-section{color:#ea9a97}.hljs-attr,.hljs-char.escape_,.hljs-keyword,.hljs-name,.hljs-operator{color:#c4a7e7}.hljs-punctuation{color:#e0def4}.hljs{color:#6e6a86}.hljs-emphasis{font-style:italic}.hljs-strong{font-weight:700}"
        case .silk:
            /*
             Theme: Silk Dark
             Author: Gabriel Fontes (https://github.com/Misterio77)
